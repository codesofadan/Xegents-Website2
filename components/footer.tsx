...
export function Footer() {
  return (
    <footer className="relative bg-gradient-to-b from-primary/5 via-secondary/5 to-accent/5 border-t border-accent/30">
      <div className="absolute inset-0 bg-muted/70 backdrop-blur-sm pointer-events-none"></div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 py-12 sm:py-16">
        ...
        <div className="space-y-8 sm:space-y-12 opacity-animation">
          <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-8 lg:gap-16">
            ...
            >
              ...
              <p className="text-xs sm:text-sm text-foreground opacity-90 leading-relaxed max-w-xl italic">
                We find the work your team shouldn't be doing, and assign it to AI.
              </p>
              <p className="text-xs sm:text-sm text-foreground/70 leading-tight font-bold">
                ~{" "}
                <a
            ...
            >
              <h4 className="text-xs sm:text-sm font-bold text-accent opacity-100">Contact</h4>
        ...
        >
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            {/* Left - Copyright */}
            <p className="text-center sm:text-left text-xs text-foreground opacity-80">
              &copy; {new Date().getFullYear()} <span className="gradient-text">Xegents</span>
              <span className="gradient-text">.</span> All rights reserved.
            </p>
