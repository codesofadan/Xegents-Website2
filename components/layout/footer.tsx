...
export function Footer() {
  ...
  return (
    <footer ref={footerRef} className="border-t border-border">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 pt-12 sm:pt-16 pb-[max(3rem,env(safe-area-inset-bottom))] sm:pb-[max(4rem,env(safe-area-inset-bottom))]">
        {/* Main Footer Content */}
        <div className="space-y-8 sm:space-y-12">
          <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-8 lg:gap-16">
            {/* Left section */}
            <div className={`space-y-3 flex-shrink-0 transition-all duration-700 ${reveal}`}>
                {/* Both company marks share the same visual height. */}
