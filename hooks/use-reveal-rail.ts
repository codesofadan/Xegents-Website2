...
/* ────────────────────────────────────────────────────────────────────────────
  ...
  2. Callers can default to the first item so the panel is populated before
    anyone has touched anything, which makes it look like static content
    rather than a response. After that the panel stays open and only swaps
    contents — opening and closing on every mouse-out would strobe.
──────────────────────────────────────────────────────────────────────────── */
 ...
 */
export function useRevealRail(railQuery = "(min-width: 1024px)", initialActiveId: string | null = null) {
